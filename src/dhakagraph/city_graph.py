...
cells.addTo(map); buildings.addTo(map); streetSegments.addTo(map); publicToPublic.addTo(map); privateToPrivate.addTo(map); privateToPublic.addTo(map); privateNodes.addTo(map); publicNodes.addTo(map); anchorLayer.addTo(map);
L.control.layers({{ 'CartoDB Positron': positron, 'OpenStreetMap': osm }}, {{ 'Buildings': buildings, 'Street Segments': streetSegments, 'Tessellation Cells': cells, 'Private Nodes': privateNodes, 'Public Nodes': publicNodes, 'Private-to-Private': privateToPrivate, 'Public-to-Public': publicToPublic, 'Private-to-Public': privateToPublic, 'Dhaka anchors': anchorLayer }}, {{ collapsed: false }}).addTo(map);
